...
const extraSlugs = ['modal', 'empty', 'loading', 'menu', 'dropdown', 'fancy-table', 'fancy-tabs', 'divider', 'form', 'note', 'sidebar', 'showcase-box', 'tag-box', 'switch', 'tooltip', 'alert', 'steps', 'progress', 'result', 'avatar', 'code-box']
const displayNames = {
