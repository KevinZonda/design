...
const extraSlugs = ['modal', 'empty', 'loading', 'menu', 'dropdown', 'fancy-table', 'fancy-tabs', 'divider', 'form', 'note', 'sidebar', 'showcase-box', 'tag-box', 'switch', 'tooltip', 'alert', 'steps', 'progress', 'result', 'avatar', 'code-box', 'grid', 'card', 'calendar', 'transfer', 'slider', 'timepicker']
const displayNames = {
  footer: 'GOV.UK footer', header: 'GOV.UK header',
  'fancy-tabs': 'FancyTabs', 'fancy-table': 'FancyTable', 'showcase-box': 'ShowcaseBox', 'tag-box': 'TagBox', 'code-box': 'CodeBox',
}
