...
export const componentDocs: ComponentDoc[] = [
  ...
  },
  {
    ...
    howItWorks: 'The banner records a local React state for the example and exposes accept and reject callbacks to the application.',
    code: `<CookieBanner onAccept={acceptCookies} onReject={rejectCookies}>\n  We use analytics cookies to understand how you use the service.\n</CookieBanner>`,
    example: () => <CookieBanner>We use some essential cookies to make this service work. We would also like to use analytics cookies.</CookieBanner>,
    api: [text('children', 'Cookie explanation.'), { name: 'onAccept', type: '() => void', description: 'Called when analytics cookies are accepted.' }, { name: 'onReject', type: '() => void', description: 'Called when analytics cookies are rejected.' }],
    wide: true,
  },
  {
  ...
  },
  {
    ...
    howItWorks: 'The link is styled as an urgent action and should point to a neutral, fast-loading destination.',
    code: `<ExitThisPage href="https://www.bbc.co.uk/weather">Exit this page</ExitThisPage>`,
    example: () => <ExitThisPage href="#exit">Exit this page</ExitThisPage>,
    api: [{ name: 'href', type: 'string', description: 'Safe destination.' }, text('children', 'Action label.')],
  },
  {
  ...
  {
    slug: 'footer', name: 'GOV.UK footer',
  ...
  {
    slug: 'header', name: 'GOV.UK header',
  ...
  },
  {
    ...
    example: () => <div className="example-tag-row"><Tag>Alpha</Tag><Tag color="green">Completed</Tag><Tag color="yellow">Waiting</Tag><Tag color="red">Rejected</Tag><Tag color="blue">Active</Tag></div>,
    api: [text('children', 'Short status text.'), { name: 'color', type: `'grey' | 'green' | 'turquoise' | 'blue' | 'purple' | 'pink' | 'red' | 'orange' | 'yellow'`, description: 'Status colour treatment.' }],
  },
  {
