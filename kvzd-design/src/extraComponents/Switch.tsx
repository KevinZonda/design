...
export const Switch = forwardRef<HTMLButtonElement, SwitchProps>(function Switch({ checked, defaultChecked = false, onChange, name, disabled = false, loading = false, size = 'm', checkedChildren = 'On', unCheckedChildren = 'Off', children, className = '', classNames, style, styles, ...props }, ref) {
