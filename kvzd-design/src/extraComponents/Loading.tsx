...
export const Loading = forwardRef<HTMLDivElement, LoadingProps>(function Loading({ variant = 'spinner', size = 'm', label = 'Loading', lines = 3, delay = 0, fullscreen = false, className = '', ...props }, ref) {
