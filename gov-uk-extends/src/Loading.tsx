...
export const Loading = forwardRef<HTMLDivElement, LoadingProps>(function Loading({ variant = 'spinner', label = 'Loading', lines = 3, className = '', ...props }, ref) {
  return <div {...props} ref={ref} className={`kvzd-loading kvzd-loading--${variant} ${className}`.trim()} role="status" aria-label={label}>
    {variant === 'spinner'
